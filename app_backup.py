    ...
    with st.sidebar:
        ...
        **OpenAI AI will automatically categorize your products based on:**
        ...
        3. **Choose** your data type:
           - **Case A**: Keywords + Description columns
           - **Case B**: Website URLs only
        4. **Process** the data with AI categorization
        ...
        **Other supported variations:**
        - Keywords: `keywords`, `keyword`, `key words`
        - Description: `description`, `company description`, `product description`
        - Company: `company_name`, `name`, `brand`, `organization`
            ...
            try:
                ...
                if case_type == "CASE_A":
                    ...
                    if has_keywords and has_description:
                        ...
                        if st.button("🚀 Process Data with AI", type="primary"):
                            ...
                            if verify_columns_for_processing(preview_df):
                                process_data(uploaded_file, config_manager, selected_date, case_type)
                            else:
                    ...
                    if has_website:
                        ...
                        if st.button("🚀 Process Data with AI", type="primary"):
                            process_data(uploaded_file, config_manager, None, case_type)
                    else:
...
def process_data(uploaded_file, config_manager, instantly_date=None, case_type="CASE_A"):
