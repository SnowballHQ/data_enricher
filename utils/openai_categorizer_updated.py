...
class OpenAICategorizer:
    ...
    def _create_categorization_and_brand_prompt(self, keywords: str, description: str, company_context: str = "") -> str:
        ...
        - This will be used in cold emails: "When we asked ChatGPT about [CATEGORY] brands like yours, it listed several competitors, but {{companyName}} didn't appear."
        - Make it specific enough that competitors would be obvious
        - AVOID generic terms like "retail", "e-commerce", "services", "solutions", "company"
        - Focus on the actual product/service offered
        
        GOOD category examples (2-4 words):
        - "Independent Hardware Stores" (not "Retail Association")
        - "Family Shoe Stores" (not "Retail Company") 
        - "RV Camping Gear" (not "E-commerce Retail")
        - "Artistic Cat Jewelry" (not "Retail & Licensing")
        - "MIL-SPEC Office Equipment" (not "Office Equipment Supplier")
        - "Electric Bike Manufacturers" (not "Electric Vehicle Manufacturing")
        - "Zero-Waste Refill Stores" (not "Sustainable Products Retailer")
        - "Custom Window Blinds" (not "Interior Design Services")
        - "Automated Vending Kiosks" (not "Automated Retail Solutions")
        ...
        More specific examples: "Cold-Pressed Juice", "Pet Grooming Salons", "Industrial Safety Equipment", "Craft Beer Breweries", "Wedding Photography Studios", "HVAC Repair Services", "Organic Dog Treats", "Custom Embroidery Shops"
        """
