...
class OpenAICategorizer:
    ...
    def _create_categorization_and_brand_prompt(self, keywords: str, description: str, company_context: str = "") -> str:
        ...
        - Try and be as specific as possible. This category will be used for cold email personalisation in this sentence - "When we asked ChatGPT about brands like yours, it listed several competitors,  but {{companyName}} didn’t appear.
        - Give singular not plural where possible and appropriate.
        
        For the brand name, extract and clean:
        - Remove URLs, promotional text, extra words
        - Use the official name the company refers to itself, think of how the owner calls the company.
        ...
        Example categories: "A/B testing software", "Cold-Brewed Coffee", "Food Truck", "Wealth Management", "Business Consulting", "Operations Planning
